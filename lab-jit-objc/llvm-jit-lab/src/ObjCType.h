...
struct method_list_t : entsize_list_tt<method64_t, method_list_t, 0x3> {
...
public list_array_tt<method64_t, method_list_t>
{
  typedef list_array_tt<method64_t, method_list_t> Super;
...
struct class_ro64_t {
  ...
  struct objc_property_list64 *baseProperties; // const struct objc_property_list (64-bit pointer)
